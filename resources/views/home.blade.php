...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow encabezado">
    ...
    <div class="container d-flex justify-content-center">
        <div class="d-flex justify-content-center align-items-center gap-4">
            <a class="nav-link botonGPC text-center" href="/Final_proyect/gpc/public/clientesadmin" style="color: #000000">
                <img src="{{ asset('image/posible_cliente.png') }}" alt="posible_cliente" width="70" height="70">
                <p><span>Clientes</span></p>
            </a>

            <a class="nav-link botonGPC text-center" href="/Final_proyect/gpc/public/vendedor" style="color: #000000">
                <img src="{{ asset('image/vendedor.png') }}" alt="vendedor" width="70" height="70">
                <p><span>Vendedores</span></p>
            </a>

            <a class="nav-link botonGPC text-center" href="/Final_proyect/gpc/public/productosadmin" style="color: #000000">
                <img src="{{ asset('image/productoservicio.png') }}" alt="producto_servicio" width="70" height="70">
                <p><span>Productos</span></p>
            </a>

            <a class="nav-link botonGPC text-center" href="/Final_proyect/gpc/public/guionadmin" style="color: #000000">
                <img src="{{ asset('image/marketing.png') }}" alt="guion" width="70" height="70">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="{{ asset('image/profile.jpg') }}">
            </a>
...
<div class="card shadow mb-4">
    ...
    <div class="card-vendedor">
        ...
        <a href="/cliente" class="boton-ingresar">Ir a Clientes</a>
    </div>
    ...
    <div class="card-vendedor">
        ...
        <a href="/producto" class="boton-ingresar">Ir a Productos</a>
    </div>
    ...
    <div class="card-vendedor">
        ...
        <a href="/guion" class="boton-ingresar">Ir a Guiones</a>
    </div>
    ...
    <div class="card-vendedor">
        ...
        <a href="/atencion" class="boton-ingresar">Ir a Atenciones</a>
    </div>
</div>
            @endif
        </div>
